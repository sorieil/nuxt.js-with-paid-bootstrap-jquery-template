        ...
        <ul>
          <li data-transition="fade" data-slotamount="7" data-masterspeed="1500">
            ...
            <div class="tp-caption customin customout"
                 ...
                 data-endspeed="300"
                 style="z-index: 5"><img class="slide-img img-responsive" src="../assets/images/slider/s21.png" alt=""/>
            </div>
            <!-- LAYER NR. 3.1 -->
            <div class="tp-caption customin customout"
                 ...
                 data-easing="Power3.easeInOut"
                 data-endspeed="300"
                 style="z-index: 6"><img class="slide-img img-responsive" src="../assets/images/slider/s22.png" alt=""/>
            </div>
            <!-- LAYER NR. 3.2 -->
            <div class="tp-caption customin customout"
                 ...
                 data-easing="Power3.easeInOut"
                 data-endspeed="300"
                 style="z-index: 7"><img class="slide-img img-responsive" src="../assets/images/slider/s23.png" alt=""/>
            </div>
            <!-- LAYER NR. 3.3 -->
            <div class="tp-caption customin customout"
                 ...
                 data-easing="Power3.easeInOut"
                 data-endspeed="300"
                 style="z-index: 8"><img class="slide-img img-responsive" src="../assets/images/slider/s24.png" alt=""/>
            </div>
          </li>
          <li data-transition="zoomin" data-slotamount="6" data-masterspeed="400">
            <!-- MAIN IMAGE -->
            <img src="../assets/images/slider/transparent.png" style="background-color:#fff" alt="" data-bgfit="cover"
            ...
            <div class="tp-caption customin customout"
                 ...
                 data-endspeed="500"
                 data-endeasing="Power4.easeIn"
                 style="z-index: 3"><img class="img-responsive" src="../assets/images/slider/s11.png" alt=""/>
            </div>
            <!-- LAYER NR. 2.1 -->
            <div class="tp-caption customin customout"
                 data-x="right"
                 ...
                 data-endspeed="500"
                 data-endeasing="Power4.easeIn"
                 style="z-index: 3"><img class="img-responsive" src="../assets/images/slider/s12.png" alt=""/>
            </div>
            <!-- LAYER NR. 2.2 -->
            <div class="tp-caption customin customout"
                 data-x="right"
                 ...
                 data-endspeed="500"
                 data-endeasing="Power4.easeIn"
                 style="z-index: 3"><img class="img-responsive" src="../assets/images/slider/s13.png" alt=""/>
            </div>
            <!-- LAYER NR. 2.3 -->
            ...
            <div class="tp-caption finewide_verysmall_white_mw paragraph customin customout tp-resizeme"
                 ...
                 data-endspeed="300"
                 style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap;">Lorem ipsum dolor sit
              amet, consetetur<br/> sadipscing elitr, sed diam nonumy<br/> eirmod tempor invidunt ut labore et<br/>
              dolore magna aliquyam erat, sed diam <br/> voluptua. At vero eos et accusam.
            </div>
            <!-- LAYER NR. 4 -->
            <div class="tp-caption sfb"
                 ...
                 data-endspeed="500"
                 data-endeasing="Power4.easeIn"
                 style="z-index: 11"><a class="btn btn-danger" href="#">Download</a> <a
          ...
          <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="600">
            <!-- MAIN IMAGE -->
            <img src="../assets/images/slider/transparent.png" style="background-color:#fea501" alt=""
            ...
            <div class="tp-caption lfl"
                 ...
                 data-captionhidden="off"><img class="img-responsive" src="../assets/images/slider/s35.png" alt=""/>
            </div>
            <!-- LAYERS NR. 2 -->
            ...
            <div
              ...
              data-endelementdelay="0.08"
              data-endspeed="300"
              style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap;">Lorem ipsum dolor sit amet,
              consetetur sadipscing elitr,<br/> nonumy voluptu ansetetur sadipscing elit. <br/> sed diam quisquam est
              nonumy voluptu vero eos et.
            </div>
          </li>
          <li data-transition="cube" data-slotamount="7" data-masterspeed="600">
            ...
            <div class="tp-caption lfl"
                 ...
                 data-endspeed="300"
                 data-endeasing="Power4.easeIn"
                 data-captionhidden="off"><img src="../assets/images/slider/s31.png" class="img-responsive" alt=""/>
            </div>
            <!-- LAYERS NR. 2 -->
            <div class="tp-caption lfl"
                 data-x="80"
                 ...
                 data-endspeed="300"
                 data-endeasing="Power4.easeIn"
                 data-captionhidden="off"><img src="../assets/images/slider/s33.png" class="img-responsive" alt=""/>
            </div>
            <!-- LAYERS NR. 3 -->
            <div class="tp-caption lfl"
                 data-x="450"
                 ...
                 data-endspeed="300"
                 data-endeasing="Power4.easeIn"
                 data-captionhidden="off"><img src="../assets/images/slider/s34.png" class="img-responsive" alt=""/>
            </div>
            <!-- LAYERS NR. 4 -->
            ...
            <div class="tp-caption skewfromright medium_text text-right paragraph"
                 ...
                 data-captionhidden="off">At vero eos etntium accu amet, adipisicing samus iusto<br/>praese delen itieos
              etconsectetur atque corrupti<br/>praese etntiumder delen itierrupti.
            </div>
            <!-- LAYERS NR. 6 // -->
          ...
          <div class="row">
            <div class="col-md-6 col-sm-6">
              ...
              <div class="showcase-item">
                <!-- Image -->
                <img class="img-responsive" src="../assets/images/etc/fruit2.png" alt=""/>
                <!-- Heading -->
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="showcase-item">
                <!-- Image -->
                <img class="img-responsive" src="../assets/images/etc/fruit3.png" alt=""/>
                <!-- Heading -->
                <h3><a href="#">Equine Porno Sumos</a></h3>
                <!-- Paragraph -->
                <p>Nam libero tempore, cum soluta nobis est minis voluptas assum simple and easy to distinguis quo.</p>
      ...
      <div class="dishes padd">
        <div class="container">
          ...
          <div class="default-heading">
            <!-- Crown image -->
            <img class="img-responsive" src="../assets/images/etc/crown.png" alt=""/>
            <!-- Heading -->
            <h2>New Dishes</h2>
            <!-- Paragraph -->
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6">
              <div class="dishes-item-container">
                ...
                <div class="img-frame">
                  <!-- Image -->
                  <img src="../assets/images/dish/dish5.jpg" class="img-responsive" alt=""/>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="dishes-item-container">
                ...
                <div class="img-frame">
                  <!-- Image -->
                  <img src="../assets/images/dish/dish6.jpg" class="img-responsive" alt=""/>
                  <!-- Block for on hover effect to image -->
                  <div class="img-frame-hover">
                    <!-- Hover Icon -->
                    <a href="#"><i class="fa fa-cutlery"></i></a>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="dishes-item-container">
                ...
                <div class="img-frame">
                  <!-- Image -->
                  <img src="../assets/images/dish/dish7.jpg" class="img-responsive" alt=""/>
                  <!-- Block for on hover effect to image -->
                  <div class="img-frame-hover">
                    <!-- Hover Icon -->
                    <a href="#"><i class="fa fa-cutlery"></i></a>
            ...
            <div class="col-md-3 col-sm-6">
              <div class="dishes-item-container">
                ...
                <div class="img-frame">
                  <!-- Image -->
                  <img src="../assets/images/dish/dish8.jpg" class="img-responsive" alt=""/>
                  <!-- Block for on hover effect to image -->
                  <div class="img-frame-hover">
                    <!-- Hover Icon -->
                    <a href="#"><i class="fa fa-cutlery"></i></a>
          ...
          <div class="menu-container">
            <div class="row">
              <div class="col-md-4 col-sm-4">
                ...
                <div class="menu-head">
                  <!-- Image for menu item -->
                  <img class="menu-img img-responsive img-thumbnail" src="../assets/images/menu/menu1.jpg" alt=""/>
                  <!-- Menu title / Heading -->
                  <h3>Seafood</h3>
              ...
              <div class="col-md-4 col-sm-4">
                ...
                <div class="menu-head">
                  <!-- Image for menu item -->
                  <img class="menu-img img-responsive img-thumbnail" src="../assets/images/menu/menu2.jpg" alt=""/>
                  <!-- Menu title / Heading -->
                  <h3>Chicken</h3>
                  <!-- Border for above heading -->
              ...
              <div class="col-md-4 col-sm-4">
                ...
                <div class="menu-head">
                  <!-- Image for menu item -->
                  <img class="menu-img img-responsive img-thumbnail" src="../assets/images/menu/menu3.jpg" alt=""/>
                  <!-- Menu title / Heading -->
                  <h3>Dessert</h3>
                  <!-- Border for above heading -->
          ...
          <div class="row">
            <div class="col-md-6 col-sm-6">
              ...
              <div class="pricing-item">
                <!-- Image -->
                <a href="#"><img class="img-responsive img-thumbnail" src="../assets/images/dish/dish3.jpg" alt=""/></a>
                <!-- Pricing item details -->
                <div class="pricing-item-details">
                  <!-- Heading -->
                  <h3><a href="#">Mix-Veg Fried Rice</a></h3>
                  <!-- Paragraph -->
                  <p>These cases are perfectly simple and distil and when nothing adipose slicing consecrate
                    prevents...</p>
                  <!-- Buy link -->
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="pricing-item">
                <!-- Image -->
                <a href="#"><img class="img-responsive img-thumbnail" src="../assets/images/dish/dish2.jpg" alt=""/></a>
                <!-- Pricing item details -->
                <div class="pricing-item-details">
                  <!-- Heading -->
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="pricing-item">
                <!-- Image -->
                <a href="#"><img class="img-responsive img-thumbnail" src="../assets/images/dish/dish4.jpg" alt=""/></a>
                <!-- Pricing item details -->
                <div class="pricing-item-details">
                  <!-- Heading -->
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <div class="pricing-item">
                <!-- Image -->
                <a href="#"><img class="img-responsive img-thumbnail" src="../assets/images/dish/dish1.jpg" alt=""/></a>
                <!-- Pricing item details -->
                <div class="pricing-item-details">
                  <!-- Heading -->
          ...
          <div class="row">
            <div class="col-md-4 col-sm-4">
              ...
              <div class="chefs-member">
                ...
                <div class="chefs-head">
                  ...
                  <img class="chefs-back img-responsive" src="../assets/images/chef/c-back2.jpg" alt=""/>
                  <!-- chef member image -->
                  <img class="chefs-img img-responsive" src="../assets/images/chef/4.jpg" alt=""/>
                </div>
                <!--Name / Heading -->
            ...
            <div class="col-md-4 col-sm-4">
              ...
              <div class="chefs-member">
                ...
                <div class="chefs-head">
                  <!-- Member background image -->
                  <img class="chefs-back img-responsive" src="../assets/images/chef/c-back1.jpg" alt=""/>
                  <!-- chef member image -->
                  <img class="chefs-img img-responsive" src="../assets/images/chef/7.jpg" alt=""/>
                </div>
                <!--Name / Heading -->
            ...
            <div class="col-md-4 col-sm-4">
              ...
              <div class="chefs-member">
                ...
                <div class="chefs-head">
                  <!-- Member background image -->
                  <img class="chefs-back img-responsive" src="../assets/images/chef/c-back3.jpg" alt=""/>
                  <!-- chef member image -->
                  <img class="chefs-img img-responsive" src="../assets/images/chef/2.jpg" alt=""/>
                </div>
                <!--Name / Heading -->
              ...
              <div class="flexslider-recent flexslider">
                <ul class="slides">
                  <li>
                    ...
                    <img class="img-responsive" src="../assets/images/dish/dish9.jpg" alt=""/>
                    <!-- Slide content -->
                    <div class="slider-content">
                      <!-- Heading -->
                      <h4>Healthy Salad</h4>
                      <!-- Paragraph -->
                      <p>Sed ut perspiciatis unde omnis iste natus error sitvolua rchitecto beatae vitae dicta sunt
                        explicabo eaque ipsa quae ab illo inventore.</p>
                    </div>
                  </li>
                  <li>
                    <!-- Image for background -->
                    <img class="img-responsive" src="../assets/images/dish/dish10.jpg" alt=""/>
                    <!-- Slide content -->
                    <div class="slider-content">
                      <!-- Heading -->
                  ...
                  <li>
                    <!-- Image for background -->
                    <img class="img-responsive" src="../assets/images/dish/dish11.jpg" alt=""/>
                    <!-- Slide content -->
                    <div class="slider-content">
                      <!-- Heading -->
                ...
                <ul class="slides">
                  <li>
                    ...
                    <div class="testimonial-item">
                      ...
                      <blockquote>
                        <!-- Paragraph -->
                        <p>Sed ut perspiciatis unde omnis iste natus error sitvolu accusative ntium doloremque
                          laudantium,
                      ...
                      <!-- Heading with image -->
                      <h4><img class="img-responsive img-circle" src="../assets/images/etc/user.jpg" alt=""/> Jhon
                  ...
                  <li>
                    ...
                    <div class="testimonial-item">
                      ...
                      <!-- Heading with image -->
                      <h4><img class="img-responsive img-circle" src="../assets/images/etc/user.jpg" alt=""/>
                  ...
                  <li>
                    ...
                    <div class="testimonial-item">
                      ...
                      <blockquote>
                        <!-- Paragraph -->
                        <p>At vero eos et accusamus et iusto odio dignis simos ducimus qui bland itiis praes entium
                          volup
                      ...
                      <!-- Heading with image -->
                      <h4><img class="img-responsive img-circle" src="../assets/images/etc/user.jpg" alt=""/> Katrina
                        Doe<span>, your designation</span></h4>
                      <div class="clearfix"></div>
                    </div>
                  </li>
